...
การบันทึกภาพ: กด `บันทึก JPG` ระบบจะสร้างภาพ 16:9 ขนาด 2560×1440 ทันที โดยบันทึกชื่อ ข้อความใต้ชื่อ และหมายเหตุทุกอย่างที่ตั้งให้แสดงบนปฏิทิน พร้อมปรับขนาดแยกแต่ละช่องตามปริมาณข้อมูล ให้ตรวจภาพก่อนแล้วกด `ดาวน์โหลด JPG` ไฟล์จะตั้งชื่อตามชนิดตาราง ชื่อหัว และเดือนโดยอัตโนมัติ
